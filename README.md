...
```html
<script src="//cdn.jsdelivr.net/gh/fauna/faunadb-js-release@2.9.1/faunadb.js"></script>
```

The minified version of the driver can also be used via CDN:

```html
<script src="//cdn.jsdelivr.net/gh/fauna/faunadb-js-release@2.9.1/faunadb-min.js"></script>
```
