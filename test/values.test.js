...
describe('Values', () => {
  ...
  test('ref', () => {
    ...
    expect(function() { new Ref(); }).toThrow();
  });
  ...
  test('bytes - errors', () => {
    expect(function() { new Bytes(10); }).toThrow();
    expect(function() { new Bytes(3.14); }).toThrow();
    expect(function() { new Bytes({}); }).toThrow();
    expect(function() { new Bytes([]); }).toThrow();
    expect(function() { new Bytes(null); }).toThrow();
    expect(function() { new Bytes(undefined); }).toThrow();
  });
