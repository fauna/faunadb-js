...
describe('query', () => {
  ...
  test('arity', () => {
    ...
    var testParams = {
      Ref: [3, 'from 1 to 2', 'Ref'],
      Do: [0, 'at least 1', 'Do'],
      Lambda: [3, 'from 1 to 2', 'Lambda'],
      Call: [0, 'at least 1', 'Call'],
      Get: [3, 'from 1 to 2', 'Get'],
      Paginate: [3, 'from 1 to 2', 'Paginate'],
      Exists: [3, 'from 1 to 2', 'Exists'],
      Create: [3, 'from 1 to 2', 'Create'],
      Match: [0, 'at least 1', 'Match'],
      Union: [0, 'at least 1', 'Union'],
      Merge: [0, 'from 2 to 3', 'Merge'],
      Intersection: [0, 'at least 1', 'Intersection'],
      Difference: [0, 'at least 1', 'Difference'],
      Format: [0, 'at least 1', 'Format'],
      Concat: [0, 'at least 1', 'Concat'],
      Casefold: [0, 'at least 1', 'Casefold'],
      FindStr: [0, 'from 2 to 3', 'FindStr'],
      FindStrRegex: [0, 'from 2 to 4', 'FindStrRegex'],
      NGram: [0, 'from 1 to 3', 'NGram'],
      Repeat: [0, 'from 1 to 2', 'Repeat'],
      ReplaceStrRegex: [0, 'from 3 to 4', 'ReplaceStrRegex'],
      SubString: [0, 'from 1 to 3', 'SubString'],
      Equals: [0, 'at least 1', 'Equals'],
      Select: [4, 'from 2 to 3', 'Select'],
      Add: [0, 'at least 1', 'Add'],
      BitAnd: [0, 'at least 1', 'BitAnd'],
      BitOr: [0, 'at least 1', 'BitOr'],
      BitXor: [0, 'at least 1', 'BitXor'],
      Divide: [0, 'at least 1', 'Divide'],
      Max: [0, 'at least 1', 'Max'],
      Min: [0, 'at least 1', 'Min'],
      Modulo: [0, 'at least 1', 'Modulo'],
      Multiply: [0, 'at least 1', 'Multiply'],
      Round: [0, 'at least 1', 'Round'],
      Subtract: [0, 'at least 1', 'Subtract'],
      Trunc: [0, 'at least 1', 'Trunc'],
      Hypot: [0, 'at least 1', 'Hypot'],
      Pow: [0, 'at least 1', 'Pow'],
      LT: [0, 'at least 1', 'LT'],
      LTE: [0, 'at least 1', 'LTE'],
      GT: [0, 'at least 1', 'GT'],
      GTE: [0, 'at least 1', 'GTE'],
      And: [0, 'at least 1', 'And'],
      Or: [0, 'at least 1', 'Or'],
      Index: [3, 'from 1 to 2', 'Index'],
      Class: [3, 'from 1 to 2', 'Class'],
      Collection: [3, 'from 1 to 2', 'Collection'],
      Database: [3, 'from 1 to 2', 'Database'],
      Function: [3, 'from 1 to 2', 'Function'],
      Role: [3, 'from 1 to 2', 'Role'],
      Classes: [2, 'up to 1', 'Classes'],
      Collections: [2, 'up to 1', 'Collections'],
      Databases: [2, 'up to 1', 'Databases'],
      Indexes: [2, 'up to 1', 'Indexes'],
      Functions: [2, 'up to 1', 'Functions'],
      Roles: [2, 'up to 1', 'Roles'],
      Keys: [2, 'up to 1', 'Keys'],
      Tokens: [2, 'up to 1', 'Tokens'],
      Credentials: [2, 'up to 1', 'Credentials'],
    }

    for (var func in query) {
      const params = testParams[func] || []
      const arity = params[0] !== undefined ? params[0] : 100
